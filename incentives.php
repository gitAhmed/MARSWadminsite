...
if (mysqli_num_rows($result) > 0) {
    ...
    ?>
				<tr class="odd gradeX">
					...
					<td>
						<a href="edit-incentive.php?account=<?php echo $id;?>" class="btn btn-default btn-sm btn-icon icon-left">
							<i class="entypo-pencil"></i>
							Edit
						</a>
						
						<a href="php/delete-incentive.php?id=<?php echo $id;?>" class="btn btn-danger btn-sm btn-icon icon-left">
