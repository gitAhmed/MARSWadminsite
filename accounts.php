...
if (mysqli_num_rows($result) > 0) {
    ...
    ?>
				<tr class="odd gradeX">
					...
					<td>
						<a href="edit-account.php?account=<?php echo $id;?>&type=student" class="btn btn-default btn-sm btn-icon icon-left">
							<i class="entypo-pencil"></i>
							Edit
						</a>
						
						<a href="php/delete-account.php?id=<?php echo $id;?>&type=student" class="btn btn-danger btn-sm btn-icon icon-left">
 ...
 if (mysqli_num_rows($result2) > 0) { 
    ...
    ?>
				<tr class="odd gradeX">
					...
					<td>
						<a href="edit-account.php?account=<?php echo $id;?>&type=instructor" class="btn btn-default btn-sm btn-icon icon-left">
							<i class="entypo-pencil"></i>
							Edit
						</a>
						
						<a href="php/delete-account.php?id=<?php echo $id;?>&type=instructor" class="btn btn-danger btn-sm btn-icon icon-left">
							<i class="entypo-cancel"></i>
							Delete
						</a>
