...
<h3>MANAGE Place Neighbors</h3>
		...
		<table class="table table-bordered datatable" id="table-3">
			...
			<tbody>
<?php
				$sql = "SELECT * FROM place_neighbor";
$result = mysqli_query($con, $sql);
...
if (mysqli_num_rows($result) > 0) {
    ...
    ?>
				<tr class="odd gradeX">
					<td>	<?php echo $id; ?> 				</td>
					<td>	<?php echo $row["placeNeighbor"] ?>	</td>
					<td>	<?php echo $row["distance"] ?>		</td>
					
					<td>
						
						
						<a href="php/delete-neighbor.php?id=<?php echo $id;?>" class="btn btn-danger btn-sm btn-icon icon-left">
