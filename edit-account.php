...
$query = "SELECT * FROM `instructor` WHERE `id` = '$account'";
 $result= mysqli_query($con,$query);
   $row = mysqli_fetch_assoc($result);
   $id 		= $row['id'];
   $fname 	= $row['f_name'];
...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
	...
	<div class="main-content">
      ...
      <div class="col-md-9 personal-info">
        ...
        <form class="form-horizontal" role="form" action="php/editing-acc.php?account=<?php echo $id;?>&type=<?php echo $type;?>" method="post">
...
echo $fname ;?>" name="form-first-name">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" type="text" value="<?php
echo $lname ;?>" name="form-last-name">
            </div>
          </div>
