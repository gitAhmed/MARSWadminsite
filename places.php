 ...
 <h3>Add Place</h3>
        ...
        <form class="form-horizontal" role="form" action="php/addplace.php" method="post">
          ...
          <div class="form-group">
            ...
            <div class="col-md-3">
              <input class="form-control" type="text" placeholder="Place name" name="name" required>
            </div>
            <div class="col-md-3">
              <input class="form-control" type="text" placeholder="Place weight" name="weight" required>
            </div>
...
if (mysqli_num_rows($result) > 0) {
    ...
    ?>
				<tr class="odd gradeX">
					...
					<td>
						<a href="edit-place.php?id=<?php echo $id;?>" class="btn btn-default btn-sm btn-icon icon-left">
							<i class="entypo-pencil"></i>
							Edit
						</a>
						
						<a href="php/delete-place.php?id=<?php echo $id;?>" class="btn btn-danger btn-sm btn-icon icon-left">
